...
namespace GXPEngine.Utility
{
    class FileReader
    {
        public static List<int[,]> LevelsCompiler()
        {
            //TODO: Code to check how many levels there are
            int numberOfLevels = 5; //change this value depending on the amount of levels found
