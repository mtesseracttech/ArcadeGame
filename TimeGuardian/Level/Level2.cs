...
namespace TimeGuardian.Level
{
    class Level2 : LevelBase
    {
        ...
        private void AddObject(int x, int y, int tile)
        {
            ...
            {
                case 17:
                    Wall wall17 = new Wall(UtilStrings.TileLevel2 + tile + ".png");
                    wall17.SetXY(x, y);
                    Walls.Add(wall17);
                    break;
                case 18:
                    Wall wall18 = new Wall(UtilStrings.TileLevel2 + tile + ".png");
                    wall18.SetXY(x, y);
                    Walls.Add(wall18);
                    break;
                case 19:
                    Wall wall19 = new Wall(UtilStrings.TileLevel2 + tile + ".png");
                    wall19.SetXY(x, y);
                    Walls.Add(wall19);
                    break;
                case 20:
                    Wall wall20 = new Wall(UtilStrings.TileLevel2 + tile + ".png");
                    wall20.SetXY(x, y);
                    Walls.Add(wall20);
                    break;
                case 21:
                    Wall wall21 = new Wall(UtilStrings.TileLevel2 + tile + ".png");
                    wall21.SetXY(x, y);
                    Walls.Add(wall21);
                    break;
                case 22:
                    Wall wall22 = new Wall(UtilStrings.TileLevel2 + tile + ".png");
                    wall22.SetXY(x, y);
                    Walls.Add(wall22);
                    break;
                case 23:
                    Wall wall23 = new Wall(UtilStrings.TileLevel2 + tile + ".png");
                    wall23.SetXY(x, y);
                    Walls.Add(wall23);
                    break;
                case 24:
                    Wall wall24 = new Wall(UtilStrings.TileLevel2 + tile + ".png");
                    wall24.SetXY(x, y);
                    Walls.Add(wall24);
                    break;
                case 25:
                    Wall wall25 = new Wall(UtilStrings.TileLevel2 + tile + ".png");
                    wall25.SetXY(x, y);
                    Walls.Add(wall25);
                    break;
                case 26:
                    Wall wall26 = new Wall(UtilStrings.TileLevel2 + tile + ".png");
                    wall26.SetXY(x, y);
                    Walls.Add(wall26);
                    break;
                case 27:
                    Wall wall27 = new Wall(UtilStrings.TileLevel2 + tile + ".png"); //INVISIBLE WALL
                    wall27.SetXY(x, y);
                    Walls.Add(wall27);
                    break;
            }
