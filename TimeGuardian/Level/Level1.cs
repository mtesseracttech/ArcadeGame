...
namespace TimeGuardian.Level
{
    ...
    {
        private readonly EnemyEagle _enemy;
        private readonly int[,] _tileMap;

        private readonly int _levelNr = 1;
        ...
        private void AddObject(int x, int y, int tile)
        {
            ...
            {
                case 17:
                    var wall17 = new Wall(UtilStrings.TileLevel1 + tile + ".png");
                    wall17.SetXY(x, y);
                    Walls.Add(wall17);
                    break;
                case 18:
                    var wall18 = new Wall(UtilStrings.TileLevel1 + tile + ".png");
                    wall18.SetXY(x, y);
                    Walls.Add(wall18);
                    break;
                case 19:
                    var wall19 = new Wall(UtilStrings.TileLevel1 + tile + ".png");
                    wall19.SetXY(x, y);
                    Walls.Add(wall19);
                    break;
                case 20:
                    var wall20 = new Wall(UtilStrings.TileLevel1 + tile + ".png");
                    wall20.SetXY(x, y);
                    Walls.Add(wall20);
                    break;
                case 21:
                    var wall21 = new Wall(UtilStrings.TileLevel1 + tile + ".png");
                    wall21.SetXY(x, y);
                    Walls.Add(wall21);
                    break;
                case 22:
                    var wall22 = new Wall(UtilStrings.TileLevel1 + tile + ".png");
                    wall22.SetXY(x, y);
                    Walls.Add(wall22);
                    break;
                case 23:
                    var wall23 = new Wall(UtilStrings.TileLevel1 + tile + ".png");
                    wall23.SetXY(x, y);
                    Walls.Add(wall23);
                    break;
                case 24:
                    var wall24 = new Wall(UtilStrings.TileLevel1 + tile + ".png");
                    wall24.SetXY(x, y);
                    Walls.Add(wall24);
                    break;
                case 25:
                    var wall25 = new Wall(UtilStrings.TileLevel1 + tile + ".png");
                    wall25.SetXY(x, y);
                    Walls.Add(wall25);
                    break;
                case 26:
                    var wall26 = new Wall(UtilStrings.TileLevel1 + tile + ".png");
                    wall26.SetXY(x, y);
                    Walls.Add(wall26);
                    break;
                case 27:
                    var wall27 = new Wall(UtilStrings.TileLevel1 + tile + ".png"); //INVISIBLE WALL
                    wall27.SetXY(x, y);
                    Walls.Add(wall27);
                    break;
            }
